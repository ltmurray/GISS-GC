GCAP2.R GISS ModelE Lat-Lon Atmosphere Model, 1850 atm./ocean

GCAP2 is based on E6F40 is based on LLF40 with updated aerosol/ozone input files for CMIP6 simulations
...
GCAP2 (LLF40 + updated aerosol/ozone input files for CMIP6 simulations, 1850 atm/ocean) 
...
NRAD=1           ! radiation computed NRAD times per source time step
#include "diag_gcap2"
